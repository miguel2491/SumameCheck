...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SumaCheck.Droid.Renderers.Camera.CameraCaptureStateListener, SumaCheck.Android", CameraCaptureStateListener.class, __md_methods);
	}
	...
	public CameraCaptureStateListener ()
	{
		...
		if (getClass () == CameraCaptureStateListener.class)
			mono.android.TypeManager.Activate ("SumaCheck.Droid.Renderers.Camera.CameraCaptureStateListener, SumaCheck.Android", "", this, new java.lang.Object[] {  });
	}
