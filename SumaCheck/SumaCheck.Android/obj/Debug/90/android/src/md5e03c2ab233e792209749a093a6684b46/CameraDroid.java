...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SumaCheck.Droid.Renderers.Camera.CameraDroid, SumaCheck.Android", CameraDroid.class, __md_methods);
	}


	public CameraDroid (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CameraDroid.class)
			mono.android.TypeManager.Activate ("SumaCheck.Droid.Renderers.Camera.CameraDroid, SumaCheck.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public CameraDroid (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CameraDroid.class)
			mono.android.TypeManager.Activate ("SumaCheck.Droid.Renderers.Camera.CameraDroid, SumaCheck.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public CameraDroid (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == CameraDroid.class)
			mono.android.TypeManager.Activate ("SumaCheck.Droid.Renderers.Camera.CameraDroid, SumaCheck.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public CameraDroid (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == CameraDroid.class)
			mono.android.TypeManager.Activate ("SumaCheck.Droid.Renderers.Camera.CameraDroid, SumaCheck.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
